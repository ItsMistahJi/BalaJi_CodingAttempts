...
button1 = tk.Button(text="       Rock       ",bg="#FFFF99",command=rock)
button1.grid(column=1,row=1)
button2 = tk.Button(text="       Paper      ",bg="#FFFF99",command=paper)
button2.grid(column=1,row=2)
button3 = tk.Button(text="      Scissor     ",bg="#FFFF99",command=scissor)
